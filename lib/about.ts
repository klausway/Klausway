...
export const ourStory = {
  ...
  paragraphs: [
    ...
    "The first of those systems was built exclusively for Klaus Larsen Roofing. The public product that grew from that work is Worknex — our flagship all-in-one platform for customers, quotes, jobs, scheduling, and teams, at work-nex.com. We also build ApronConnect, branded online ordering for independent restaurants. Klaus Way continues to design, build, and run products and custom systems for companies that need more than one-size-fits-all software.",
